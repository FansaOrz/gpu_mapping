...
private:
	...
	ros::Publisher costmap_cloud_pub;
   ...
   nav_msgs::Path path_msg;
	...
	float passthrough_ground_height;	// passthrough ground height
...
public:
	...
	void imu_calc(ros::Time current_time1);
	...
	// piece map functions
	void try_to_create_piece_map(const pose cur_pose, const pcl::PointCloud<Point>::ConstPtr &current_pointcloud);
	...
	bool pose2GeometryPose__(geometry_msgs::Pose &to, const pose &from);
};
